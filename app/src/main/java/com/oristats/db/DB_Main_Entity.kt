...
data class DB_Main_Entity (
    @PrimaryKey @ColumnInfo(name = "start_time") var start_time: Long,    //System.currentTimeMillis()
    ...
    //@ColumnInfo(name = "end_raw_row") var end_raw_row: Int,       // create my own way of rowing the raw entries. (The autogenerate primarykey in raw_table can be kept, if I want to.)
